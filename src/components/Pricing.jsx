        ...
        <div key={index} className="w-full p-2 sm:w-1/2 lg:w-1/3">
          <div className="p-10 border border-neutral-700 rounded-xl">
            <p className="mb-8 text-4xl">
              {option.title}
              {option.title === "Pro" && (
                <span className="mb-4 ml-2 text-xl text-transparent bg-gradient-to-r from-orange-600 to-red-500 bg-clip-text">
                  (Most Popular)
                </span>
              )}
            </p>
            ...
            <a
              href="#"
              className="inline-flex items-center justify-center w-full h-12 p-5 mt-20 text-xl tracking-tight text-center transition duration-200 border border-purple-900 rounded-lg hover:bg-purple-800"
            >
              Subscribe
            </a>
          </div>
